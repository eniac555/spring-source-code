...
/*
    Aware 接口及 InitializingBean 接口---属于内置功能，不会失效
 */
public class A06 {
    ...
    public static void main(String[] args) {
        ...
        //为了让@Autowired @PostConstruct等注解生效
        ...
        /*
            ...
            例1: 用 Aware 注入 ApplicationContext 成功, 而 @Autowired 注入 ApplicationContext 失败
         */


        /*
            例2: Java 配置类在添加了 bean 工厂后处理器后,
                用传统接口方式的注入和初始化仍然成功, 而 @Autowired 和 @PostConstruct 的注入和初始化失败
         */
